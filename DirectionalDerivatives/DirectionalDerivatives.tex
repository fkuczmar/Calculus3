...
First use the level curves (spaced at intervals of width $\Delta h = 0.2$) of the function $f$ and the graph to approximate the rate. Then find the exact rate. Be sure to include units.
