...
\begin{question} \label{QLFD43rr34}
Use the ratio test to determine the opne interval of convergence of the sum
\[
   \sum_{n=1}^\infty \frac{n^3x^{3n}}{4^{3n}}.
\]

\begin{explanation}
The nth term of the series is
\[
     a_n = \frac{n^3x^{3n}}{4^{3n}} = n^3 \left( \frac{x}{4} \right)^{3n}.
\]
The (n+1)st term is
\begin{align*}
    a_{n+1} &= (n+1)^3 \left( \frac{x}{4} \right)^{3(n+1)} .
\end{align*}
And the ratio of consecutive terms is
\begin{align*}
  \frac{a_{n+1}}{a_n}  &= \frac{(n+1)^3}{n^3} \left( \frac{x}{4} \right)^3  \\
                                  &= \left( \frac{n+1}{n} \right)^3 \left( \frac{x}{4} \right)^3  \\
                                  &= \left( 1 + \frac{1}{n} \right)^3 \left( \frac{x}{4} \right)^3
\end{align*}
So
\begin{align*}
     \lim_{n \to \infty} \left|  \frac{a_{n+1}}{a_n}\right| &= \lim_{n \to \infty}  \left( 1 + \frac{1}{n} \right)^3 \left| \frac{x}{4} \right|^3    \\
                  &= \left| \frac{x}{4} \right|^3 .
\end{align*}

By the ratio test, the sum
\[
   \sum_{n=1}^\infty \frac{n^3x^{3n}}{4^{3n}}.
\]
converges if
\[
   \lim_{n \to \infty} \left|  \frac{a_{n+1}}{a_n}\right| = \left| \frac{x}{4} \right|^3 < 1,
\]
or equivalently if
\[
           |x| < 4 .
\]
So the open interval of convergence of the sum
\[
   \sum_{n=1}^\infty \frac{n^3x^{3n}}{4^{3n}}.
\]
is
