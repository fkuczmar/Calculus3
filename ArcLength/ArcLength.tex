...
Suppose ${\bf p}(s)$ is an arclength parameterization of the curve shown below and that
\[
   \overrightarrow{AB} = {\bf p}(2) \,\,\,\, \text{and} \,\,\,\, \overrightarrow{AC} = {\bf p}(5) .
\]
Sketch the following vectors as accurately as possible. Explain your reasoning.
