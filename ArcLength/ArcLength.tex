...
Parameterize by arclength the circle of radius $a$ centered at the origin and lying the the $xz$-plane. Take $s=0$ (the arclength parameter) at the point $A(a,0,0)$ and the positive direction to be counterclockwise as viewed from the point $(0,1,0)$. The coordinates have units of meters.
