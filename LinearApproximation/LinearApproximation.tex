...
\begin{onlineOnly}
    \begin{center}
\desmosThreeD{967c10cbdc}{900}{600}
\end{center}
\end{onlineOnly}
...
\href{https://www.desmos.com/3d/yxipqmtful}.
}
 
\begin{onlineOnly}
    \begin{center}
\desmosThreeD{vmm7nypyuk}{900}{600}
\end{center}
\end{onlineOnly}
...
(d) Suppose $s=400$, $h=200$, and $p=2$. Use part (b) to approximate the maximum error in measuring the angle of elevation to make the relative error in the computed height at most $5\%$.

(e) Suppose  you can stand any distance from the tree and still have an unobstructed view of its top. Suppose also that the error in measuring the angle of elevation is at most $\Delta \theta$ radians and that the relative error in measuring the distance to the base of the tree is at most $p\%$. Where should you stand to minimize the relative error in the computed height of the tree above eye level?
