...
Suppose we are given the velocity and acceleration vectors of a motion at a certain time, either graphically or numerically. How would we determine whether the object is speeding up or slowing down at this instant? And how can we approximate or compute this rate of change of speed with respect to time?
...
\item The idea is to forget about the position function. Instead we'll imagine the hodograph and write the velocity function of a motion
in polar form as
\[
