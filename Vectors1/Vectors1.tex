...
\begin{document}
\begin{abstract}
Introductions to vectors. Just the basics.
\end{abstract}
\maketitle
...
\item  Draw a picture to show that if the vectors ${\bf v}$ and ${\bf w}$ are not parallel, then
\[
      | {\bf v-w}  | < |  {\bf v} | + |  {\bf w} |.
\]
...
\[
       |  {\bf w} | = 4 .
\]
What can you say about the possible values of $|{\bf v-w}|$? Draw pictures (at least three) to help with your explanation. 
...
\begin{question} \label{Q:DLFD33r3}
