...
\begin{exploration}
Drag points $A$, $B$, $C$, and $D$ to see how the vector projection of ${\bf v}$ in the direction of ${\bf w}$ changes. Watch also the vector component of ${\bf v}$ perpendicular to ${\bf w}$.
\pdfOnly{
