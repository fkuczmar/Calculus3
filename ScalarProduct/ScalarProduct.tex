...
(a) Given vectors ${\bf v}, {\bf w} \in \mathbb{R}^n$, use the scalar product to determine the value of the number $\lambda\in \mathbb{R}$ that makes the vector
\[
...
Let ${\cal L}$ be the line through the origin and the point $A(3,1,4)$ and let $Q$ be the point with coordinates $(7,5,11)$.
...
\section{Reflecting off a Mirror}
