...
Look at the graph above to approximate the coordinates of $P$ in the $uv$-system. Assume the axes have the same scale as in the $xy$-coordinate system.
\end{question}
