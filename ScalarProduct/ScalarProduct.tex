...
Which of the following are equivalent to the condition that the non-zero vectors ${\bf a}, {\bf b} \in \mathbb{R}^n$ are perpendicular? Check all that apply. Draw pictures to explain your reasoning. No computations.
...
\]
or (squaring both sides) if and only if
\[
