...
Suppose the points $A(1,2,-1)$, $B(3,-4,5)$, and $C(-2,1,4)$ are consecutive vertices of a parallelogram. Use the arithmetic and geometry of vectors to find the coordinates of the fourth vertex $D$. Draw a picture (in two dimensions) to help with your explanation.

Do this first in general (ignoring the particular coordinates above) by letting $O$ be the origin and expressing the vector $\vv{OD}$ in terms of other vectors.
...
\begin{onlineOnly}
    \begin{center}
\desmosThreeD{5qzqbw87tv}{900}{600}
\end{center}
\end{onlineOnly}
