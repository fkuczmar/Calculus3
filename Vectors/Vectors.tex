...
Let ${\cal L}$ be the line through the points $A$ and $B$ in three dimensions. Let $O$ be the origin.

\begin{enumerate}
\item Use vector arithmetic to find expression the position relative to the origin of all points on ${\cal L}$ that are $3$ units from $A$ in terms of the vectors $\overrightarrow{OA}$ and $\overrightarrow{OB}$. Work in general, not with the specific points shown below.

To do this, let $P$ be such a point and express the vector $\overrightarrow{OP}$ in terms of the vectors $\overrightarrow{OA}$ and $\overrightarrow{OB}$. Check your work in the desmos worksheet below inputting these expressions on Lines 7 and 8.
...
\item Find vector equations of the sphere(s) centered on ${\cal L}$ of radius $3$ through $A$. For these equations, let ${\bf p}=\langle x,y,z \rangle$, ${\bf a} = \langle 1,2,3 \rangle$, and ${\bf b} = \langle -2,1,1 \rangle$ be the vectors from the origin to the points $P(x,y.,z)$, $A(1,2,3)$, and $B(-2,1,1)$. 
...
\item Hide the spheres by turning off Lines 2 and 4. Then use vector arithmetic to express the vector $\overrightarrow{OP}$ from the origin to a point of tangency in terms of the vectors $\overrightarrow{OA}$ and $\overrightarrow{OB}$. Use the desmos worksheet to check your work. Work in general, not with the specific points given here.
