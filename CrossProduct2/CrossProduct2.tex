...
\[
   {\bf n} = {\bf u}\times {\bf v}
\]
perpendicular to the plane ${\cal P}$. Now the since the vector ${\bf w}$ is orthogonal to both ${\bf u}$ and ${\bf n}$, it is parallel to either% compute it as either the cross product
\[
...
\begin{multipleChoice}
\choice[correct]{$({\bf u}\times {\bf v})\times {\bf u}$}
\choice{${\bf u} \times ({\bf u}\times {\bf v})$}
\end{multipleChoice}
...
\begin{onlineOnly}
    \begin{center}
\desmosThreeD{5xncpr9qoy}{900}{600}
\end{center}
\end{onlineOnly}
