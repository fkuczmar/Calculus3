...
Paramterize the line ${\cal L}$ in $\mathbb{R}^3$ through the points $A(1,2,3)$ and $B(-2,1,1)$.
...
\begin{explanation}
Instead of using the points $A$ and $B$ to find a slope of the line as we would in the plane, we instead use them to find a vector
\begin{align*}
