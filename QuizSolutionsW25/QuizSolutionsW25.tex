...
\begin{align*}
       \overrightarrow{AP_1} &= 4\left| \overrightarrow{OB}  \right|  {\bf u}  \\
                                        ...
                                        &=4 \frac{\left| \overrightarrow{OB}\right|}{\left| \overrightarrow{OB} -\overrightarrow{OA} \right|}\cdot \left( \overrightarrow{OB} - \overrightarrow{OA} \right) .
\end{align*}

Therefore,
\begin{align*}
                 \overrightarrow{OP_1} &= \overrightarrow{OA} +\overrightarrow{AP_1} \\
                                                  &= \overrightarrow{OA} + 4 \frac{\left| \overrightarrow{OB}\right|}{\left| \overrightarrow{OB} -\overrightarrow{OA} \right|}\cdot \left( \overrightarrow{OB} - \overrightarrow{OA} \right) .
\end{align*}
