...
\item Sketch the graph of this function by hand. Check your work by activating the folder in Line 1 below.
...
\item Find an expression for the linear function $z=L(x,y)$ that best approximates $f(x,y)$ near the point $(3,4)$.
...
\begin{question} \label{Qpdf93r}

This question is about launching a projectile from the origin and trying to hit a target in the $xy$-plane. It's really about how samll errors in your aim affect the accuracy of the projectile.

\begin{onlineOnly}
    \begin{center}
\desmosThreeD{o9dwgzpj1l}{900}{600}
\end{center}
\end{onlineOnly}

Desmos activity available at

\href{https://www.desmos.com/3d/o9dwgzpj1l}{163: Target Practice}
