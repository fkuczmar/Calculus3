...
(a) How many possibilites are there for the vertex $C$ of our square?
\begin{multipleChoice}
\choice{none}
\choice{one}
\choice[correct]{two}
...
(b) The first step is to find a vector ${\bf n}$ normal to the plane through $A$, $B$, and $C$. Do this.
\begin{hint}
A vector ${\bf n}$ is normal to the plane if and only if ${\bf n}$ is normal to the vectors ${\bf b}-{\bf a}$ and $\answer{{\bf p}}-{\bf a}$. So we can choose
\[
   {\bf n} = ( {\bf b}-{\bf a}  ) \answer{\times} (\answer{{\bf p}}-{\bf a})  .
\] 
\end{hint}

\begin{onlineOnly}
    \begin{center}
\desmosThreeD{qe6zmh2y3p}{900}{600}
\end{center}
\end{onlineOnly}

\href{https://www.desmos.com/3d/qe6zmh2y3p}{163: Square}
