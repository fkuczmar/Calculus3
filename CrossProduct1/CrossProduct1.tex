...
(a) Our first goal is to express the vector $\overrightarrow{QP}$ in terms of the angle $\theta$ from $\overrightarrow{QA}$ to  $\theta$ from $\overrightarrow{QB}$. This angle is measured continuously and is taken to be positive in the counterclockwise direction. Do this as follows:

(i) Find the vector projection of $\overrightarrow{OP}$ onto $\overrightarrow{QA}$.
\[
    ( \answer{\cos \theta} )\overrightarrow{QA}
\]

(ii) Find the vector projection of $\overrightarrow{OP}$ onto $\overrightarrow{QB}$.
\[
    ( \answer{\sin \theta} ) \overrightarrow{QB}
\]

(iii) Use the results of (i) and (ii) to write $\overrightarrow{OP}$ as a linear combination of  $\overrightarrow{QA}$ and $\overrightarrow{QB}$.
\[
  \overrightarrow{OP} = ( \answer{\cos \theta} )\overrightarrow{QA} + (\answer{\sin \theta}) \overrightarrow{QB}
\]


\begin{onlineOnly}
    \begin{center}
\desmos{6mdhdrpoqn}{900}{600}
\end{center}
\end{onlineOnly}

\href{https://www.desmos.com/calculator/6mdhdrpoqn}{163: Equilateral Triangles in the Plane}
...
\begin{onlineOnly}
    \begin{center}
\desmosThreeD{5az4ulr1l0}{900}{600}
\end{center}
\end{onlineOnly}

\href{https://www.desmos.com/3d/5az4ulr1l0}{163: Intersecting Circles}
\end{question}
