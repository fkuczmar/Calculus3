...
\section{Straight Lines on a Sphere}

\begin{question}  \label{Q9df7udsftr}
The problem here is to 
\begin{enumerate}
\item{parameterize the great circle through given points $A$ and $B$ on a sphere of radius $R$. A great circle is centered at the sphere's center.}
\item{parameterize the shorter arc of that great circle, and}
\item{to compute the length of that arc.}
