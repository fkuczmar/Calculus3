...
\begin{document}
\begin{abstract}
A preview of some ideas we'll study in this class.
\end{abstract}
\maketitle
...
(c) Now just one more step. Remember, our goal is to show that $\overline{SP}$ sweeps out area at a constant rate. That is, we need to show that $dA/dt$ is constant. For this, we need an expression for the derivative $d\theta/dt$. I'll leave this to you. Here's a hint if you need help getting started.
