...
\begin{document}
\begin{abstract}
A preview of some applications. THIS IS A TEST
\end{abstract}
\maketitle
...
\begin{hint}
Start by relating $\theta$ and $t$ with the tangent function. %You may assume $0 \leq \theta < \pi/2$. 
\[
