...
Given two spheres that intersect, we wish to parameterize their circle of intersection.

We are given three distinct points $A$, $B$, $Q$ in space. 

The spheres through $Q$ centered at $A$ and $B$ could possibly be tangent at $Q$, but most likely intersect in a circle. Try using the idea of the previous question to parameterize this circle.
