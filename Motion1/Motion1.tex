...
\]
expresses the position (in meters) of the gnat relative to the origin in terms of the number of seconds past noon. But between times $t=2$ and $t=5$ seconds past noon, the gnat flies with a constant velocity. Find a multi-part function that gives the gnat's position (in meters) relative to the origin between times $t=0$ and $t=5$. 
