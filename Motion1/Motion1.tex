...
\]
expresses the velocity of a beetle (in m/sec) in terms of time (in seconds). The bug has position
\[
...
\item Try to sketch the beetle's path. Sketch velocity and acceleration vectors along the path at equally-spaced time intervals.

\item Find an expression for the position function ${\bf p}(t)$.

\item Find an expression for the acceleration function ${\bf a}(t)$.

\item Activate the folder on Line 2 and play the slider on Line 1 in the animation below to check how you did.

\item Any observations about the velocity and acceleration vectors? What does the hodograph tell you?

\begin{onlineOnly}
    \begin{center}
\desmosThreeD{womvfsqwir}{900}{600}
\end{center}
\end{onlineOnly}
...
\begin{onlineOnly}
    \begin{center}
\desmosThreeD{yg911q55im}{900}{600}
\end{center}
\end{onlineOnly}


\href{https://www.desmos.com/3d/yg911q55im}{163: Cornu Spiral 2}
