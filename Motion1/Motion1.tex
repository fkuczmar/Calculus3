...
\begin{selectAll}  
    \choice{$20 + r(t)$}  
    \choice{$\int r(t)\, dt + C$}  
    \choice{$20 + \int_{t_0}^u r(t)\, dt$}  
    \choice[correct]{$20 + \int_{t_0}^t r(u)\, du$}  
  \end{selectAll}
\end{question}
...
\begin{selectAll}  
      \choice{$\int {\bf v}(t)\, dt + C$}  
    \choice{${\bf p}_0 + \int_{t_0}^u {\bf v}(t)\, dt$}  
    \choice[correct]{${\bf p}_0 + \int_{t_0}^t r(u)\, du$}  
  \end{selectAll}
\end{question}
