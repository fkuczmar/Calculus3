...
(a) Input the components of the angular velocity vector for this rotation of ${\bf R}^3$. There are two possibilities for $\boldsymbol{\omega}$. Give the one that rotates the $xy$-plane as in the animation of Question 5. 
\[
...
(d) Express the speed $v$ (in meters/sec) of $P$ in terms of the distance $r = |{\bf r}|$ and the rotation rate $\omega  =\boldsymbol{\omega}$.
