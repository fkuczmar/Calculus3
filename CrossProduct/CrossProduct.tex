...
A rotation in space is about an axis, not a point. To describe both the sense and the rate of a rotation about the axis, we give a vector ${\bf \omega}$ parallel to the axis. The vector ${\bf\omega}$ is called the \emph{angular velocity} of the rotation. The components have units of rad/sec and the magnitude $|{\bf \omega}|$ gives the rotation rate. To get the sense of rotation, use the right-hand rule. Point your right thumb in the direction of ${\bf \omega}$ and curl your fingers about the axis.


Now imagine the $xy$-coordinate system in the animation above as being the $xy$-plane in a three-dimensional coordinate system. The postive $z$-axis points directly out of the page.
