...
\begin{multipleChoice}  
\choice{${\bf v} = {\bf r} \times \boldsymbol{\omega}$}  
\choice[correct]{${\bf v} = \boldsymbol{\omega} \times {\bf r}$}  
\end{multipleChoice}  
...
\begin{selectAll}   
\choice{The vector ${\bf v}$ initially points into the page, vanishes when $Q$ coincides with $G$, and then points out of the page. }  
\choice{The vector ${\bf v}$ points out of the page until $Q$ passes $G$ and then it points into the page. }  
\choice[correct]{The vector ${\bf v}$ always points into the page.}  
\choice{The magnitude $|{\bf v}|$ is always positive except at $G$ where it vanishes.} 
\choice[correct]{The magnitude $|{\bf v}|$ is constant and equal to the speed of $P$.}
\choice[correct]{The vector ${\bf v}$ is constant and equal to the velocity of $P$. }
\end{selectAll}    
