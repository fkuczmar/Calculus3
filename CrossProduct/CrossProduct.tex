...
Check that the sense of rotation is correct in the animation below, where $\boldsymbol{\omega} = \overrightarrow{OP}$. Drag points $P$ and $A$ to see if the sense of rotation remains correct.
