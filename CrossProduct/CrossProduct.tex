...
{\bf Takeaway:} It pays to pay attention to units. In applications, it is usually best to interpret the magnitude of the cross product {\bf not} as an area, but in some other way.
