...
\item Use calculus to find the coordinates of the point on the line closest to the point $P$ with coordinates $(4,7,5)$. \emph{Hint:} Treat this as an optimiation problem.
...
\begin{onlineOnly}
    \begin{center}
\desmosThreeD{dixdkj4j77}{900}{600}
\end{center}
\end{onlineOnly}

\href{https://www.desmos.com/3d/znxtexpsnt}{163: Closest Point on a Line}
