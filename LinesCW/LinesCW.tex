...
This particular hoop has center $(0,0,3)$ meters and radius $b=2$ meters, but try to work in general, with center $(0,0,a)$ and radius $b$.
...
\begin{enumerate}
\item Start by using trigonometric functions to paramaterize the hoop in terms of the marked polar angle $\theta$.

The vector $\overrightarrow{AP}$ from the center of the hoop to the point $P$ on the hoop with polar angle $\theta$  has components
\[
