...
(d) Find the coordinates of three points in the first octant that respectively lie on two spheres tangent to the coordinate planes, on exactly two such spheres, and on no such sphere.
...
(i) Are any point of ${\cal S}$ uncolored? If so, which points?
