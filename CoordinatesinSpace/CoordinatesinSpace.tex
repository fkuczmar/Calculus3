...
\begin{freeResponse}
(a) Is the point $Q(0,-2,3)$ the center of a sphere through the points $A(1,-3,4)$ and $B(3,1,-2)$? Explain your reasoning.
...
\[
   z = f(x,y) = 3x - 2y - 3.
\]
So can choose $x$ and $y$ to be arbitrary real numbers (our two degrees of freedom), say 
\[
    x = u  \text{ and } y = v ,
\]
and then
...
\begin{onlineOnly}
    \begin{center}
\desmosThreeD{103agdltxu}{900}{600}
\end{center}
\end{onlineOnly}

\href{https://www.desmos.com/3d/103agdltxu}{163: Spheres Through Two Points 2}
