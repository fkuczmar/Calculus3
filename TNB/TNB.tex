...
The principal normal ${\bf N}(t)$ is a unit vector normal to the path and parallel to the osculating plane. It makes  ${\bf T}(t)$, ${\bf N}(t)$, ${\bf B}(t)$ a right-handed coordinate system. Here ${\bf T}(t)$ is the unit vector parallel to the velocity
\[
...
\begin{question} \label{Qdf3rr3}
Use methods (c) and (b) above to compute the principal normal and binormal of the motion
\[
  {\bf p}(t) = \Biggr \langle  t, \frac{t^2}{2} -2, \frac{t^3}{8} \Biggr \rangle \, , \, -4 \leq t \leq 4 ,
\]
