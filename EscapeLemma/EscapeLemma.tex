...
\begin{question} \label{Q9df3frefe}

\begin{onlineOnly}
   \begin{center}
\desmos{r8cesb4sxa}{900}{600}
\end{center}
\end{onlineOnly}

\href{https://www.desmos.com/calculator/r8cesb4sxa}{163: Escape Lemma 55}

Identify the paths on the path of the motion ${\bf p}(t)$ shown above where the expression
\[
      \frac{1}{\left| {\bf p}^\prime(t) \right|} \cdot \frac{d}{dt} \left( \left| {\bf p}(t) \right|   \right)
\]
equals
