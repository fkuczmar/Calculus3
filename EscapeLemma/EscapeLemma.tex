...
\]
This approximates the change in the beetle's distance from the origin in terms of the angle $\theta$ between its position and velocity vectors and the distance it crawls.
