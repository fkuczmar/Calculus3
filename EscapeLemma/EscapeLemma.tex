...
\begin{enumerate}
\item working with the components of vectors, in violation of the second principle above, 
...
\emph{The rate of change in the distance to the origin is the scalar component of the velocity vector in the direction of the position (relative to the origin) vector.}
