...
\frac{d}{dt}\Big| {\bf p}(t)  \Big| &=  \frac{d}{dt} \left(\sqrt{x^2+y^2}\right)    &&   \frac{d}{dt}\Big| {\bf p}(t)  \Big| = \frac{d}{dt} \left(  \sqrt{{\bf p} \cdot {\bf p}} \right) \\
 &= \frac{2x \frac{\answer{dx}}{\answer{dt}}+ 2y \frac{\answer{dx}}{\answer{dt}}}{2\sqrt{x^2 + y^2}}  && \hskip 0.5 in = \frac{{\bf v}\cdot {\bf p} + {\bf p}\cdot {\bf v}}{2\sqrt{{\bf p}\cdot {\bf p}}} \\
...
\item the rate of change (with respect to time) in the distance of the beetle from $O$ at this moment.

\item the rate of change in the distance of the beetle from $O$ at this moment. This time the rate of change is with respect to the distance the beetle crawls.
...
\item Suppose at this moment the fly is moving away from the origin at the rate of $7$ m/sec. Use vector arithmetic, \emph{not} algebra, to find a possibility for the fly's velocity  at this time.
