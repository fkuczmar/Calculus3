...
But in desmos, we do vector arithmetic with the points directly and define a third point, call it $C$, as
\[
    C = B - A.
\]
To see point $C$, activate Line 7 above.

\emph{Note:} We should \emph{not} write $C = B-A$ in this class other than in desmos. Instead we should write the vector equation above.
